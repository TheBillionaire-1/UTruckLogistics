...
import { ArrowLeft, MapPin, Clock, Package, X, XCircle, Activity, TrendingUp } from "lucide-react";
...
export default function CustomerHistory() {
  ...
  const filteredBookings = bookings?.filter(booking => {
    ...
    if (statusFilter === "cancelled") return booking.status === BookingStatus.CANCELLED;
    return true;
  }) || [];
